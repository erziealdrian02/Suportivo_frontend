 ...
 <div class="container">
  <div class="row">
   <div class="col">
    <div class="mySlides">
    <?php
          $d = $this->db->query("Select*from produk_media Where id_media=23")->row()->media;
          echo "<img  height=350 width=550 src=\"" . base_url() . "images/$d\" />";
          ?>
  </div>
  <div class="mySlides">
    <?php
          $d = $this->db->query("Select*from produk_media Where id_media=24")->row()->media;
          echo "<img  height=350 width=550 src=\"" . base_url() . "images/$d\" />";
          ?>
  </div>
  <div class="mySlides">
...
<div class="col">
 <div class="col brief">
  <div class="box title">
       <h2 class="namaproduk">Rise
        <small id="product-model-name">Up</small>
       </h2>
       <hr>
       <?php
          $d = $this->db->query("Select*from sub_category Where id_sub_category=3")->row()->deskripsi;
          echo "<p>$d</p>";
          ?>
          <br>
          <?php
             $d = $this->db->query("Select*from produk_media Where id_media=25")->row()->media;
             echo "
             <video height=300 width=300 controls=controls loop=loop></iframe>
 ...
 <section id="content2">
  <div class="container">
  <h4>WKWKWKWKWKWKWKWKWKWkwkwkwkwkwkwkwkwkwkwk</h4>
  <table class="table">
    <thead>
      <tr class="supp">
        <th>Spesifikasi</th>
  ...
  <table class="table table-striped">
   ...
   <tbody>
      <?php
        $db = $this->db->get_where('produk_software', array ('id_sub_category' =>1));
        foreach ($db->result() as $key) {
          echo "<tr>";
