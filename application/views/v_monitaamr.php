...
<main>
 ...
 <div class="container">
  ...
  <div class="mySlides">
    <?php
          $d = $this->db->query("Select*from produk_media Where id_media=26")->row()->media;
          echo "<img  height=350 width=450 src=\"" . base_url() . "images/$d\" />";
          ?>
  </div>
  <div class="mySlides">
...
<div class="col">
 <div class="col brief">
  <div class="box title">
       <h2 class="namaproduk">Samsung recommends Windows.
...
(NP900X5M-K05)
       ...
       <hr>
       <?php
          $d = $this->db->query("Select*from sub_category Where id_sub_category=2")->row()->deskripsi;
          echo "<p>$d</p>";
          ?>
          <br>
          <?php
 ...
 <section id="content2">
  <div class="container">
  <h4>Monita AMR (Automatic Meter Reading)</h4>
  <table class="table">
    <thead>
      <tr class="supp">
        <th>Spesifikasi</th>
  ...
  <table class="table table-striped">
    ...
    <tbody>
      <?php
         $db = $this->db->get_where('download', array ('id_sub_category' =>3));
        foreach ($db->result() as $key) {
          echo "<tr>";
          echo "<td>" . $key->waktu_update . "</td>";
          echo "<td>" . $key->versi . "</td>";
