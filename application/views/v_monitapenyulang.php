...
<main>
 ...
 <div class="container">
  ...
  <div class="mySlides">
    <?php
          $d = $this->db->query("Select*from produk_media Where id_media=30")->row()->media;
          echo "<img  height=350 width=350 src=\"" . base_url() . "images/$d\" />";
          ?>
  </div>
  <div class="mySlides">
...
<div class="col">
 <div class="col brief">
  <div class="box title">
       <h2 class="namaproduk">Panasonic Sikat
    ...
    Elektrik Analyzer
       ...
       <hr>
       <?php
          $d = $this->db->query("Select*from sub_category Where id_sub_category=4")->row()->deskripsi;
          echo "<p>$d</p>";
          ?>
          <br>
          <?php
 ...
 <section id="content2">
  ...
  <table class="table table-striped">
    ...
    <tbody>
      <?php
         $db = $this->db->get_where('download', array ('id_sub_category' =>4));
        foreach ($db->result() as $key) {
          echo "<tr>";
          echo "<td>" . $key->waktu_update . "</td>";
          echo "<td>" . $key->versi . "</td>";
